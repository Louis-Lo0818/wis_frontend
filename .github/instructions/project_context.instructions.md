...
The authoritative project plan lives at:

```
.agent_plan/
└── day_dream/
    └── wis_frontend/           ← Active blueprint (read this before planning work)
        ├── 00_index.md         ← Navigation hub, phase progress overview
        ├── 01_executive_summary.md
        ├── 02_architecture.md
        ├── 03_feature_dashboard.md
        ├── 04_feature_import.md
        ├── 05_feature_inventory.md
        ├── 06_feature_transfer.md
        ├── 80_implementation.md ← Phase tasks and statuses (check here first)
        ├── 81_module_structure.md
        └── 99_references.md
```

**Blueprint Templates**: `my-react-app/data/.agent_plan/day_dream/templates/`  
**Planning Instructions**: `my-react-app/data/instructions/planning/`
...
6. **Blueprint-Driven**: Check `.agent_plan/day_dream/wis_frontend/80_implementation.md` before starting new work to align with current phase.
